...
public class AboutView extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Program ini dibuat untuk desa sugeng oleh mahasiswa Universitas Widya Kartika Surabaya");

        jLabel2.setText("Programmer :");

        jLabel3.setText("Steven Gunanto 083854968000 stevengunanto.blogspot.com");

        jLabel4.setText("Andrean Kristanto");

        jLabel5.setText("Stephanie Elvina");

        jLabel6.setText("Meliani Salim");

        jLabel7.setText("Fanny Lindawati");

        jLabel8.setText("Johan Prasetio");
